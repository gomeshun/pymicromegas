...
#ifdef CONSTRAINTS
{    
   double cl=ZpLimCMS("Zp");
   if(cl>=1) printf(" Zp is excluded by CMS experiment  2103.02708\n");
}
#endif
...
{ printf("Late Inflaton decay\n");
  ...
  printf("HInfl=%E GammaInfl=%E BrInfl=%E\n",HInfl,GammaInfl,BrInfl);
...
#ifdef SHOWPLOTS   
 displayPlot("e+", "E", Mcdm*1.E-5 , Mcdm,0,2
                                      ,"electron",0,SpectdNdE,SpE
                                      ,"photon",0,SpectdNdE,SpA); 
#endif
