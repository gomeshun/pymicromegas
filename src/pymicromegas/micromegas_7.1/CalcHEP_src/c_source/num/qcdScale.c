...
static FILE*fout;
static void  (*scaleCC_)(int nsub,REAL*,double (*calcPV)(char,char*,double*), double *,double*,double*,double*,double*) =NULL;
...
static void ScaleCCM12(int nsub,REAL*modelVal, double (*calcPV)(char,char*,double*), double *pvect,double *Qren, double *Qpdf1,double *Qpdf2, double*Qshow)
{  double Q= sqrt( fabs( (pvect[0]+pvect[4]+pvect[3]+pvect[7])*(pvect[0]+pvect[4]-pvect[3]-pvect[7])));
   if(Q<1)Q=1;
   *Qren= Q;
   *Qpdf1=Q;
   *Qpdf2=Q;
...
{  char *ch;
   ...
   if(scaleLib && scaleLib!=ScaleCCM12) dlclose(scaleLib);
   if(strcmp(sR,"M12")==0 && strcmp(sF1,"Qren")==0 && strcmp(sF2,"Qpdf1")==0 )
   { 
      scaleCC_=ScaleCCM12; return 0;}
