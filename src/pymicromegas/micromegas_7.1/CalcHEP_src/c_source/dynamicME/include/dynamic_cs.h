...
extern double   pWidth(const char *name, txtList * LL);
extern int      pWidthPref(const char *name, int pref);
...
extern void setQforParticle(REAL *Q,const char*pname);
#ifndef __cplusplus
...
extern double lGGqcd(double Q,char* hName);
#endif
