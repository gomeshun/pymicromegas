...
static long double complex* slhaValAddress(const char * Block, int nKey, int *keys)
{
  char BLOCK[BlckLn];
...
static long double  complex cslhaVal_(const char * Block, double Q, int nKey, va_list ap)
{ 
  int keys[KeyMLn];
  int i;
  char BLOCK[BlckLn];
...
double  slhaValFormat(const char * Block, double Q, const char * format)
{ 
  int keys[KeyMLn];
  int i;
  char BLOCK[BlckLn];
...
int   slhaSTRFormat(const char * Block, const char * format, char *txt)
{ 
  int keys[KeyMLn];
  int i;
  char BLOCK[BlckLn];
...
double complex cslhaVal(const char * Block, double Q, int nKey,...)
{
  double complex R;
  va_list ap;
  va_start(ap,nKey);
...
double slhaVal(const char * Block, double Q, int nKey, ...)
{   
  double complex R;
  va_list ap;
  va_start(ap,nKey);
...
int slhaValExists(const char * Block, int nKey, ...)
{ 
  va_list ap; 
  int keys[KeyMLn];
