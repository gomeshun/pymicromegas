...
extern double  slhaVal(const char * Block, double Q, int nKey, ...);
extern double  slhaValFormat(const char * Block, double Q, const char * format);
extern int   slhaSTRFormat(const char * Block, const char * format, char *txt);
#ifndef __cplusplus
extern double complex cslhaVal(const char * Block, double Q, int nKey, ...);
#endif
extern int slhaValExists(const char * Block, int nKey, ...);
...
extern double betaQCD(double alpha, int nf);
extern double gammaQCD(double alpha, int nf);


extern int initQCD(double MZalphaS,double McMc,double MbP,double MtP);
extern int initQCD5(double MZalphaS,double McMc,double MbMb,double MtP);
extern int initQCDH(double Q0,  double alphaS, double McMc, double MbMb, double MtMt);

extern void hWidthCoeff2(double Mh, double*C1,double*C2);
...
extern double McPole,MbPole,MtPole;
extern double cPoleMass(void);
