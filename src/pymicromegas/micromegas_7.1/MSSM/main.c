...
printf("pval=%e experiment=%s\n", pval,expName);
  double fact=DD_factor(AllDDexp, 0.1,Maxwell, &expName);
  printf("DD_fact=%.3E\n",fact); 
fact=DD_factor(AllDDexp-LZ5T_2024, 0.1,Maxwell, &expName); 
    printf("DD_fact without LZ5T_2024=%.3E\n",fact); 
}
#endif
