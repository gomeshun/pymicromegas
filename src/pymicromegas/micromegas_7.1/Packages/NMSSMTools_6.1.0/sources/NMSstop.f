...
*
     ...
     .     CST,CSB,CSL,asmu1,asmu2,asnmu1,csmu
      ...
      DOUBLE PRECISION MS,MC,MB,AMB,AMT,AMTAU,MMUON,MZ,MW
      DOUBLE PRECISION g1s,g2s,g3s,HTOPS,HBOTS,HTAUS
      DOUBLE PRECISION NS_stbchiw,NS_stbchihc,NS_stbnustau,NS_stbsnutau
      DOUBLE PRECISION NS_stbnusmu,NS_stbsnumu,NS_stbnusel,NS_stbsnuel
      DOUBLE PRECISION NS_stbsbstart,NS_stbbsbt,NS_sttausbnu,NS_stelsbnu
      DOUBLE PRECISION NS_st2st1tt,NS_st2st1bb,NS_st2st1uu,NS_st2st1dd
      DOUBLE PRECISION NS_st2st1ee,NS_st2st1nunu,NS_st2st1tautau
      DOUBLE PRECISION NS_st2st1startt,NS_ay,NS_by,NS_ax,NS_bx
