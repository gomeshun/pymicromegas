...
*******************************************************************
      ...
      INTEGER NHZH1,NHZH2,NHZH3,NHZH4,NHHH,NHHH2,NHHH3
      INTEGER NHZHT1,NHZHT2,NHZHT3,NHZHT4,NHHHT,NHHHT2,NHHHT3
      INTEGER NGGCH,NGGCHT
      INTEGER HZHT1(10000,3),HZHT2(10000,3),HZHT3(10000,3)
      INTEGER HZHT4(10000,3),HHHT(10000,3),HHHT2(10000,3)
      INTEGER HHHT3(10000,3),GGCHT(10000,3)
      ...
      DOUBLE PRECISION HHH3(10000,3),GGCH(10000,3)
...
C      write(*,*) 'EXPCON_PATH=', EXPCON_PATH  
...
* Read CMS 13TeV upper limit
* HGG4(I,1): Higgs mass
* HGG4(I,2): upper on sigma[H_125]/sigma_SM*BR[H->2gamma] limit in pb
      FILENAME=catpath(EXPCON_PATH,'2405.18149_6a.dat')
      OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
      I=1
 2803 READ(11,*,END=2804,ERR=2)(HGG4(I,J),J=1,2)
      I=I+1
      GOTO 2803
 2804 NHGG4=I-1
      CLOSE(11)
...
* Read CMS 13TeV upper limit
* HGG5(I,1): Higgs mass
* HGG5(I,2): upper on sigma[H_125]/sigma_SM*BR[H->2gamma] limit in pb
      FILENAME=catpath(EXPCON_PATH,'2405.18149_6c.dat')
      OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
      I=1
 2805 READ(11,*,END=2806,ERR=2)(HGG5(I,J),J=1,2)
      I=I+1
      GOTO 2805
 2806 NHGG5=I-1
      CLOSE(11)
...
* Read ATLAS 13TeV upper limit
* HGG6(I,1): Higgs mass
* HGG6(I,2): upper limit on sigma[H_125]/sigma_SM*BR[H->2gamma] in pb
      FILENAME=catpath(EXPCON_PATH,'2407.07546_6b.dat')
      OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
      I=1
 2807 READ(11,*,END=2808,ERR=2)(HGG6(I,J),J=1,2)
      HGG6(I,2)=HGG6(I,2)/(.237d0-.928d0*HGG6(I,1)/1d3)
      I=I+1
      GOTO 2807
 2808 NHGG6=I-1
      CLOSE(11)
...
* Read CMS upper limit
* HAABS3(I,1): CP-odd Higgs mass
* HAABS3(I,2): upper limit on sigma[H_125]/sigma_SM*BR[H->2A]*BR[A->2b]**2
      FILENAME=catpath(EXPCON_PATH,'2403.10341_3c.dat')
      OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
      I=1
 2821 READ(11,*,END=2822,ERR=2)(HAABS3(I,J),J=1,2)
      HAABS2(I,2)=HAABS3(I,2)
      I=I+1
      GOTO 2821
 2822 NHAABS2=I-1
      CLOSE(11)
...
* Read CMS upper limit
* HAATAUS4(I,1): CP-odd Higgs mass
* HAATAUS4(I,2): upper limit on sigma[H_125]*BR[H->2A]*BR[A->2tau]**2
      FILENAME=catpath(EXPCON_PATH,'1907.07235_10.dat')
      OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
      I=1
 2905 READ(11,*,END=2906,ERR=2)(HAATAUS4(I,J),J=1,2)
      I=I+1
      GOTO 2905
 2906 NHAATAUS4=I-1
      CLOSE(11)
...
* Read CMS upper limit
* HHH2(I,1): Heavy Higgs mass
* HHH2(I,2): Light Higgs mass
* HHH2(I,3): upper limit on sigma[H]*BR[H->HSMHS]*BR[HSM->2b]*BR[HS->2b] in pb
      FILENAME=catpath(EXPCON_PATH,'2204.12413_4b.dat')
      OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
      I=1
...
* Read CMS upper limit
* HHH3(I,1): Heavy Higgs mass
* HHH3(I,2): Light Higgs mass
* HHH3(I,3): upper limit on sigma[H]*BR[H->HSMHS]*BR[HSM->2gam]*BR[HS->2b] in pb
      FILENAME=catpath(EXPCON_PATH,'2310.01643_8b.dat')
      OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
      I=1
 2931 READ(11,*,END=2932,ERR=2)(HHH3(I,J),J=1,3)
      I=I+1
      GOTO 2931
 2932 NHHH3=I-1
      CLOSE(11)
      CALL TRITAB(HHH3,NHHH3,HHHT3,NHHHT3)
...
* Read Charged Higgs production cross section, from LHCHWGMSSMCharged Twiki
* GGCH(I,1): Charged Higgs mass
* GGCH(I,2): tan(beta)
* GGCH(I,3): gg -> tH+
      FILENAME=catpath(EXPCON_PATH,'chargedHiggs.dat')
      OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
      I=1
 3011 READ(11,*,END=3012,ERR=2)(GGCH(I,J),J=1,3)
      I=I+1
      GOTO 3011
 3012 NGGCH=I-1
      CLOSE(11)
      CALL TRITAB(GGCH,NGGCH,GGCHT,NGGCHT)
