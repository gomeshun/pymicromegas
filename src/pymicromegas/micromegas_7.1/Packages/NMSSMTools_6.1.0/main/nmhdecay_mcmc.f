...
************************************************************************
      ...
      INTEGER HFLAG,UNCERTFLAG,GRFLAG,MWFLAG
...
!      WRITE(17,*)""
 ...
 102    PAR(1)=LCEN+MAX(DABS(LCEN),LMIN)*LDEV*GAU(IDUM)
       ...
       IF(AU3DEV.EQ.0d0)THEN
        PAR(12)=AU3CEN
       ELSE
        PAR(12)=AU3CEN+MAX(DABS(AU3CEN),AU3MIN)*AU3DEV*GAU(IDUM)
       ENDIF

       IF(AD3DEV.EQ.0d0)THEN
        PAR(13)=AD3CEN
       ELSE
        PAR(13)=AD3CEN+MAX(DABS(AD3CEN),AD3MIN)*AD3DEV*GAU(IDUM)
       ENDIF

       IF(AE3DEV.EQ.0d0)THEN
        PAR(14)=AE3CEN
       ELSE
        PAR(14)=AE3CEN+MAX(DABS(AE3CEN),AE3MIN)*AE3DEV*GAU(IDUM)
       ENDIF

       IF(AE2DEV.EQ.0d0)THEN
        PAR(25)=AE2CEN
       ELSE
        PAR(25)=AE2CEN+MAX(DABS(AE2CEN),AE2MIN)*AE2DEV*GAU(IDUM)
       ENDIF

       IF(ML3DEV.EQ.0d0)THEN
        PAR(10)=ML3CEN**2
       ELSE
        PAR(10)=(ML3CEN+MAX(DABS(ML3CEN),ML3MIN)*ML3DEV*GAU(IDUM))**2
       ENDIF

       IF(ML2DEV.EQ.0d0)THEN
        PAR(18)=ML2CEN**2
       ELSE
        PAR(18)=(ML2CEN+MAX(DABS(ML2CEN),ML2MIN)*ML2DEV*GAU(IDUM))**2
       ENDIF

       IF(ME3DEV.EQ.0d0)THEN
        PAR(11)=ME3CEN**2
       ELSE
        PAR(11)=(ME3CEN+MAX(DABS(ME3CEN),ME3MIN)*ME3DEV*GAU(IDUM))**2
       ENDIF

       IF(ME2DEV.EQ.0d0)THEN
        PAR(19)=ME2CEN**2
       ELSE
        PAR(19)=(ME2CEN+MAX(DABS(ME2CEN),ME2MIN)*ME2DEV*GAU(IDUM))**2
       ENDIF

       IF(MQ3DEV.EQ.0d0)THEN
        PAR(7)=MQ3CEN**2
       ELSE
        PAR(7)=(MQ3CEN+MAX(DABS(MQ3CEN),MQ3MIN)*MQ3DEV*GAU(IDUM))**2
       ENDIF

       IF(MQ2DEV.EQ.0d0)THEN
        PAR(15)=MQ2CEN**2
       ELSE
        PAR(15)=(MQ2CEN+MAX(DABS(MQ2CEN),MQ2MIN)*MQ2DEV*GAU(IDUM))**2
       ENDIF

       IF(MU3DEV.EQ.0d0)THEN
        PAR(8)=MU3CEN**2
       ELSE
        PAR(8)=(MU3CEN+MAX(DABS(MU3CEN),MU3MIN)*MU3DEV*GAU(IDUM))**2
       ENDIF

       IF(MU2DEV.EQ.0d0)THEN
        PAR(16)=MU2CEN**2
       ELSE
        PAR(16)=(MU2CEN+MAX(DABS(MU2CEN),MU2MIN)*MU2DEV*GAU(IDUM))**2
       ENDIF

       IF(MD3DEV.EQ.0d0)THEN
        PAR(9)=MD3CEN**2
       ELSE
        PAR(9)=(MD3CEN+MAX(DABS(MD3CEN),MD3MIN)*MD3DEV*GAU(IDUM))**2
       ENDIF

       IF(MD2DEV.EQ.0d0)THEN
        PAR(17)=MD2CEN**2
       ELSE
        PAR(17)=(MD2CEN+MAX(DABS(MD2CEN),MD2MIN)*MD2DEV*GAU(IDUM))**2
       ENDIF
...
*********************************************************************
      ...
      DOUBLE PRECISION HCBRSQ(5),HCBRSL(3),HCBRSUSY,HCWIDTH,CHTBXS
