...
************************************************************************
      ...
      INTEGER NFLAG,UNCERTFLAG,ITRY,SFFLAG,GRFLAG,MWFLAG
...
!      WRITE(17,*)"GMFLAG=",GMFLAG
!      WRITE(17,*)"MSUSYEFF =",MSUSYEFF
!      WRITE(17,*)"MMESS =",MMESS
!      WRITE(17,*)"TANB =",PAR(3)
!      WRITE(17,*)"LAMBDA =",PAR(1)
!      IF(GMFLAG.EQ.0)THEN
!       WRITE(17,*)"ALAMBDA=",ALINP
!       IF(MAFLAG.EQ.-3 .OR. MAFLAG.EQ.-4)WRITE(17,*)"KAPPA =",PAR(2)
!       IF(MAFLAG.EQ.-1 .OR. MAFLAG.EQ.-2)WRITE(17,*)"XIF =",XIFINP
!       IF(MAFLAG.EQ.-1 .OR. MAFLAG.EQ.-3)WRITE(17,*)"XIS =",XISINP
!       IF(MAFLAG.EQ.-2 .OR. MAFLAG.EQ.-4)WRITE(17,*)"MS =",MSINP
!       IF(MUPINP.NE.0d0)WRITE(17,*)"MUP =",MUPINP
!       IF(MSPINP.NE.0d0)WRITE(17,*)"MSP =",MSPINP
!      ENDIF
!      IF(GMFLAG.EQ.1 .OR. GMFLAG.EQ.3)THEN
!       WRITE(17,*)"XiU =",XIU
!      ENDIF
...
!       WRITE(17,*)""
     ...
     .    (GUTEST.GT.1d-6.AND.LOOP.LT.100))THEN
        CALL LPTSOLVE(IFAIL)
        IF(IFAIL.NE.0)THEN
!         WRITE(17,*)"RGE integration problem 5"
...
!        WRITE(17,*)"No convergence 3"
!        WRITE(17,*)"Exit (IFAIL=18)"
!        WRITE(17,*)""
!        WRITE(17,*)""
        IFAIL=18
        GOTO 11
...
*   Check MSMES=MSREF if GMFLAG>0
     ...
     .       *(2d0*LPPMES**2+3d0*LTTMES**2+LUMES**2+LDMES**2)
       ...
       ENDIF
!       WRITE(17,*)"MSREF =",MSREF
!       WRITE(17,*)"MSMES =",MSMES
!       WRITE(17,*)"D =",D
!       WRITE(17,*)""
!       WRITE(17,*)""
      ENDIF
