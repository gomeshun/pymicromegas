...
def limits(case="J", ndwarf = ["Draco",], deltaEXCL = 3.84, filescan="misc/scan_mV_EV.dat", root = "profiling_case2"):
    ...
    if case == "J":
        if len(ndwarf) == 1:
            ...
            for i, nd in enumerate(ndwarf_mod): # run over dwarf
                ...
                os.system('rm -f excl_limits_case{}/sv_limits_case{}_'.format(case, case) + str(nd) + '.dat')
            ...
            os.system('rm -f excl_limits_case{}/sv_limits_caseJ_'.format(case) + '+'.join(ndwarf) + '.dat')
    ...
    #            plt.axvline(x=sv_new[kmin])
        ...
        os.system('rm -f excl_limits_case{}/sv_limits_caseJB_'.format(case) + '+'.join(ndwarf) + '.dat')
