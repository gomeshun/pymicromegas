...
# Silently ignore all UserWarning messages
...
def main():
    ...
    os.system("rm -rf ./profiling_case{}".format(case))
...
#    else:
#        print("Point in DM parameter space excluded by Fermi-LAT gamma-ray data from dwarf spheroidal galaxies at 95% confidence level!")
#    print(int(res[1] <= 1.0))
