...
void improveCrossSection(long n1,long n2,long n3,long n4 ,double PcmIn,double T, 
double * res) { return; }
...
void improveCrossSection(long n1,long n2,long n3,long n4 ,double PcmIn, double T,  double * res) 
{
